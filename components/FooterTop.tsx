...
const ContactItem = ({icon, title,subtitle}:Props) => {
  return <div className='flex items-center gap-3 group hover:bg-gray-50 p-4 transition-colors cursor-pointer'>
    {icon}
    <div>
