...
const AboutPage = () => {
  return (
    <div>
      ...
      <h1 className="text-3xl font-bold mb-6">About Shopzee</h1>
      <p className="mb-4">
        Shopzee is a cutting-edge technology company dedicated to providing
      ...
      <p>
        At Shopzee, we believe in the power of technology to transform businesses
